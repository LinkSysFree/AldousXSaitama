...
let like_time_second = 5;
let share_time_second = 5;
let subscribe_time_second = 5;
...
function linkForLikeShareWatch(){
  if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      window.open("https://youtu.be/GsEjf0oxH-c?si=lVb0RXEWpMGruyqx");//aldousXsaitama
} else {
    window.open("https://youtu.be/GsEjf0oxH-c?si=lVb0RXEWpMGruyqx", "_blank");//aldousXsaitama   
}
}
